...
windows_64bit_dll_path = os.path.join(absolute_path, 'lib\\windows\\64bit\\Ginkgo_Driver.dll')
windows_32bit_dll_path = os.path.join(absolute_path, 'lib\\windows\\32bit\\Ginkgo_Driver.dll')
macos_dll_path = os.path.join(absolute_path, 'lib\\macos\\libGinkgo_Driver.dylib')
linux_32bit_dll_path = os.path.join(absolute_path, 'lib\\linux\\32bit\\libGinkgo_Driver.so')
linux_64bit_dll_path = os.path.join(absolute_path, 'lib\\linux\\64bit\\libGinkgo_Driver.so')
# Import library
if platform.system() == "Windows":
    if "64bit" in platform.architecture():
        print(windows_64bit_dll_path)
