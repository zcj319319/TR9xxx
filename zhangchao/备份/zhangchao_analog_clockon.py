...
write_spi_reg(0x10,0x7c,0x37)#analog clock on
write_spi_reg(0x10,0x35,0x00)
write_spi_reg(0x10,0x35,0x18)
write_spi_reg(0x10,0x71,0x00)
write_spi_reg(0x10,0x71,0x18)
