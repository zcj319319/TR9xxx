...
if use_4g == 1:
    os.system('D:\projects\DIQUN\write\zhangchao\diqun_serdes_tx_test_PLL_4GHz.py')
else:
    os.system('D:\projects\DIQUN\write\zhangchao\diqun_serdes_tx_test_PLL_8GHz.py')
