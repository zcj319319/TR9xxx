...
if only_test_serdes_prbs7==1:
    os.system('D:\projects\DIQUN\diqun_fpga\write\zhangchao\diqun_serdes_tx_test_step3_PRBS7z.py')
else:
...
#ddc config begins
    ...
    if ddc_nco_bypass == 1:
        ...
        write_spi_reg(0x03, 0x17, 0x00)
        write_spi_reg(0x03, 0x18, 0x00)
        write_spi_reg(0x03, 0x19, 0x00)
        write_spi_reg(0x03, 0x1a, 0x20)
    ...
    write_spi_reg(0x03, 0x00, 0x11)#reset nco
    write_spi_reg(0x03, 0x00, 0x01)
...
#204b config begins
    write_spi_reg(0x05, 0xf9, 0x01)#sysref_came_delay
    if use_4g == 1:
