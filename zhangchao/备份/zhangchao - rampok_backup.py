...
import os
os.system('D:\projects\DIQUN\write\zhangchao\zhangchao_analog_clockon.py')
sleep(0.5)
use_4g=0;
if use_4g == 1:
...
if test_204b ==1:
    ...
    write_spi_reg(0x05, 0x8c, 0x01)
    write_spi_reg(0x05, 0x8d, 0x1f)
    write_spi_reg(0x05, 0x8e, 0x01)
    write_spi_reg(0x05, 0x8f, 0x0f)
    write_spi_reg(0x05, 0x90, 0x0f)
    write_spi_reg(0x05, 0x91, 0x03)
    ...
    ddc_nco_bypass = 0 # use adc source, not nco test data
    if ddc_nco_bypass == 1:
    ...
    ddc_test_bypass = 1# is ramp, not sin
