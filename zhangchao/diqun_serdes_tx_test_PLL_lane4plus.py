...
###zwrite_spi_reg(0x10,0x7d,0x0C)  ## refclk divider div 0x0c=24

write_spi_reg(0x11,0x46,0x28) ####
####PLL FBC divider by 60
###zwrite_spi_reg(0x11,0x48,0x3c) ####div  by 24
...
write_spi_reg(0x10,0x88,0x50) ## clock buffer is enlarged
##enable and reset 
write_spi_reg(0x10,0x89,0xf0) ## all tx blocks are enabled
write_spi_reg(0x10,0x89,0xf1) ## rstb is released
